...
if (config.LOCAL_SERVERS) DEFAULT_SERVER_ROOT = "http://127.0.0.1:8080";
else DEFAULT_SERVER_ROOT = "http://23.20.0.206";
...
function constructItemFromBSO(o) {
  ...
  if (o.deleted) {
    ...
    try {
      ...
      L.log("Failed to construct item from BSO", e.message, o.payload);
      item = {};
    }
  }
  item.id = o.id;
