...
function getUserId(args) {
  ...
  if (!userId) throw "Missing user in args and no this.userId set";
  return userId;
}
...
StorageServerClient.prototype.getCollectionsInfo = function(args) {
  ...
  // TODO: this error doesn't seem to work and needs a test
...
StorageServerClient.prototype.readCollection = function(args) {
  ...
  headers = buildHeaders({ token: getToken.call(this, args), newer: args.newer });
