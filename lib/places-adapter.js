...
module.exports.DESCRIPTION_ANNO     = "bookmarkProperties/description";
module.exports.SIDEBAR_ANNO         = "bookmarkProperties/loadInSidebar";
module.exports.QUERY_ANNO           = "Places/SmartBookmark";
module.exports.ALLBOOKMARKS_ANNO    = "AllBookmarks";
module.exports.MOBILEROOT_ANNO      = "mobile/bookmarksRoot";
module.exports.MOBILE_ANNO          = "MobileBookmarks";
module.exports.EXCLUDEBACKUP_ANNO   = "places/excludeFromBackup";
module.exports.ORGANIZERQUERY_ANNO  = "PlacesOrganizer/OrganizerQuery";
