...
const BOOKMARK_QUERY_TRAILER =
    ...
    " ON item_annos.anno_attribute_id = anno_attrs.id) AS t " +
    " ON t.item_id = bookmark.id) " +
...
function readRawAllBookmarks() {
  ...
  var processRow = function(row) {
    ...
    oneResult.id = row.getResultByName('b_id');
    ...
    oneResult.annoName = row.getResultByName('a_name');
