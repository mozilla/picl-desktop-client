...
try {
  Cu.import('resource://gre/modules/identity/IdentityService.jsm');
} catch (e) {
  L.log("WARNING: Please use special nightly build to use PICL with Persona. Instructions here: https://github.com/mozilla/picl-desktop-client#logging-in-with-persona.");
}
